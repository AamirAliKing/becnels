...
// Add a new component that extends CardContent with link functionality

interface CardContentLinkProps extends React.HTMLAttributes<HTMLDivElement> {
  href?: string
}
...
CardContentLink.displayName = "CardContentLink"
...
export { Card, CardHeader, CardFooter, CardTitle, CardDescription, CardContent, CardContentLink }
